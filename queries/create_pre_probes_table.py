...
from diamond_miner.queries.query import Query, StoragePolicy, pre_probes_table
from diamond_miner.typing import IPNetwork


@dataclass(frozen=True)
class CreatePreProbesTable(Query):
    ...
    def statement(
        ...
        return f"""
        CREATE TABLE IF NOT EXISTS {pre_probes_table(measurement_id)}
        (
