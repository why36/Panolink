...
class CreateTables(Query):
    ...
    def statements(
        ...
        return (
            ...
            *CreateASProbesTable(**params).statements(measurement_id, subset),
            *CreateMapTable(**params).statements(measurement_id, subset),
            *CreateBGPTable(**params).statements(measurement_id, subset),
            *CreatePreProbesTable(**params).statements(measurement_id, subset),
            # *CreateLinksView(**params).statements(measurement_id, subset),
            *CreateGroupMapping(**params).statements(measurement_id, subset),
        )
